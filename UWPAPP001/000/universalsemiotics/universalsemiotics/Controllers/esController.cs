...
namespace universalsemiotics.Controllers
{
    ...
    public class esController : Controller
    {
        protected override void OnActionExecuting(ActionExecutingContext ctx)
        {
            ...
            if (Request != null)
            {
                ...
                if (Request.Cookies["idioma"] != null)
                {
                    ...
                    {
                        Response.Cookies.Add(new HttpCookie("idioma", "es-ES"));
                    }
                    else
                    {
                        Response.Cookies["idioma"].Value = "es-ES";
                    }
                }
                else
                {
        ...
        [HttpGet]
        public ActionResult Caracteres()
        {
        ...
        [HttpGet]
        public ActionResult texto_a_voz_pro()
        {
            String userIdS = System.Web.HttpContext.Current.User.Identity.GetUserId();
            Guid userId = new Guid(userIdS);
        ...
        public async Task<String> texto_a_voz_pro(String titulo, String texto, String idioma, String voz)
        {
            try
            {                
                if (String.IsNullOrEmpty(titulo)) { return "... El título no puede quedar en blanco ..."; }
                if (String.IsNullOrEmpty(texto)) { return "... El texto no puede quedar en blanco ..."; }
                if (String.IsNullOrEmpty(voz)) { return "... La voz no puede quedar en blanco ..."; }
                if (idioma != "es-ES" && idioma != "en-US" && idioma != "fr-FR" && idioma != "de-DE" && idioma != "it-IT") { return "... Idioma incompatible ..."; }
                ...
                using (universalsemioticsEntities bbdd = new universalsemioticsEntities())
                {
                    ...
                    if(uD == null)
                    {
                        bbdd.UsersData.Add(new UsersData() { UserId = userId, caracteres = 0 });
                        bbdd.SaveChanges();
                        return "... No dispone de caracteres suficientes para esta conversión ...";
                    }
                    else
                    {
        ...
        [HttpGet]
        public ActionResult texto_a_voz()
        {
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<String> texto_a_voz(String titulo, String texto, String idioma)
        {
            try
            {
                ...
                using (universalsemioticsEntities bbdd = new universalsemioticsEntities())
                {
                    ...
                    if (lastmp3 != null)
                    {
                        ...
                        {
                            return "... Según el tamaño de su último archivo debe esperar [" + resto.TotalSeconds.ToString("N0") + "] segundos para procesar otro o esperar a que termine el actual ...";
                        }
                    }
                }
        ...
        public String getEPUBPDFText()
        {
            ...
            try
            {
                if (Request.Files[0].ContentLength > 50 * 1024 * 1024) return "Su archivo es demasiado grande, por favor, reduzca su contenido.";
            ...
            {
                resultS = "No se puede leer este EPUB/PDF";
            }
        ...
        public async Task<String> PublicidadI(String titulo, String urlD)
        {
            try
            {
                if (Request.Files[0].InputStream.Length != 0 && !String.IsNullOrEmpty(urlD) && !String.IsNullOrEmpty(titulo))
                {
                    ...
                    {
                        return "... Sólo se soportan archivos de imagen con extensión gif, png, jpg o jpeg ...";
                    }
                    ...
                    using (System.Drawing.Bitmap objbitmap = new System.Drawing.Bitmap(Request.Files[0].InputStream))
                    {
                        ...
                        {
                            return "Sólo se admiten imágenes de 100 x 100 píxeles (gif, png, jpg o jpeg)";
                        }
                    }
                    ...
                    String body = "<p> <a href='https://www.universalsemiotics.com/es/xdc4cb595729d341d6c5d12943a5a3371e7612528?id32po=" + id + "'>ver</a><br/>" + urlD + "<br/>" + user.Email + "</p>";

                    Utils.SendMail("apzyx@yahoo.com", "NUEVA PUBLI", body);

                    return "... Su publicidad se envió correctamente ...";
                }
                else
                {
            ...
            if (pps == "holaadios")
            {
                using (universalsemioticsEntities bbdd = new universalsemioticsEntities())
                {
                    ...
                    String body = "<h1>Banner Aceptado</h1>" +
                        ...
                        "<br/><br/><p>Ahora puede realizar la inversión que desee en su banner</p>" +
                        "<p><a href='https://www.universalsemiotics.com/es/InversionBANNER?id=" + id + "' target='_blank'>clica aquí para realizar su inversión</a></p>" +
